...
<title>관리자 학사일정 페이지</title>
 ...
 <!-- 달력jquery 이거js파일에 넣었더니 에러나고 작동안됨 --> 
      ...
      <div id="basic">
         ...
         <div id="body">
            ...
            <div class="servicebutton">
               ...
               <input type="button" class="bothB" id="oneB" onclick="getAPlanList()">              
            ...
            <div id="undermainpage">
      			    <input placeholder="시작일" type="text" onfocus="(this.type='date')" id="sd">
       	   			<input placeholder="종료일" type="text" onfocus="(this.type='date')" id="ed">
